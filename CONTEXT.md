Overall Context: Kollektiv.Sanntid.org - Real-time Norwegian public transport departure board. Version 1.37.33.

Current Goal: Stable mobile PWA experience across Chrome and Firefox.

Last 3 Changes:

- Scroll threshold visual hint (v1.37.33): Added .scroll-more-indicator--triggered CSS class; arrow+label turn accent color with fast bounce when drag threshold is crossed; removed on finger lift before load fires
