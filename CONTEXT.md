...
Last 3 Changes:
- Firefox mobile scroll fix (v1.37.19): Added touch-action: pan-x to .board in scroll-more.css to eliminate Firefox jank caused by touchmove preventDefault stalling the browser scroll pipeline
